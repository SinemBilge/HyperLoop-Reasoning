"""
Experiment 4: Evaluate Stage 2 Hyperbolic (Full Pipeline)
Evaluates T5 after KI training + Hyperbolic parsing + hopping prompts
"""
...
def evaluate_hyperbolic():
    print("="*60)
    print("Experiment 4: Stage 2 Hyperbolic (Full Pipeline)")
    print("="*60)
    ...
    # Load model
    print(f"[2/5] Loading {model_name} with Hyperbolic layer...")
    ...
    hopping_dir = "checkpoints/stage2_hyperbolic_hopping"
