...
python train_knowledge_integration.py --dataset mlpq --epochs 50 --checkpoint_save_path checkpoints/mlpq/knowledge_integration/ --tboard_logs_save_path tboard_logs/mlpq/knowledge_integration/ --batch_size 32 --learning_rate 0.001 --additional_layer identity
